...
<title>Spring Tea - Forgot Password</title>
</head>
<body>
<h1><em>Spring Tea - Forgot Password</em></h1>
<div class ="navbar">
<ul>
...
<form id="form" action="passwordrecover.php" method="post">
<h1 class="info">Get Your Password</h1>
